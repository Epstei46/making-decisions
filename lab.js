...
// instructions said if temp <= 60, regardless of rain, one should wear a jacket and carry an umbrella, so not checking rain variable in that else if statement.
...
console.log("initally set to " + changeMyMind)
if (changeMyMind === true){
  changeMyMind = false
  console.log("changed to " + changeMyMind)
